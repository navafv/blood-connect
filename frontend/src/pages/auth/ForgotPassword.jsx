    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          Enter your organization email address and we'll send you a link to
          reset your password.
        </p>
      </div>
            ...
            <div className="text-center animate-in fade-in zoom-in duration-500">
              ...
              <div className="p-4 bg-slate-950 rounded-lg border border-slate-800 mb-6">
                <p className="text-xs text-slate-500 mb-2">
                  <strong className="text-rose-400">Developer Note:</strong>{" "}
                  Check your Django backend terminal! The reset link has been
                  printed there instead of being emailed.
                </p>
              </div>
