          ...
          {status === "success" ? (
            <CardContent className="pt-12 pb-12 flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
              ...
              <Link to="/login" className="block w-full">
                <Button
                  variant="outline"
                  className="w-full py-6 text-base font-semibold rounded-xl transition-all border-slate-200 bg-white hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-200 dark:hover:bg-slate-800"
                >
            ...
            <CardContent className="pt-8 px-8 pb-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center pt-2">
                  <Link
                    to="/login"
                    className="inline-flex items-center text-sm font-semibold transition-colors duration-300 text-slate-600 hover:text-rose-600 dark:text-slate-400 dark:hover:text-rose-400"
                  >
                    <ArrowLeft className="mr-2 h-4 w-4" />
                    Back to Login
                  </Link>
